...
- "View departments". Даёт доступ к чтению и просмотру отделов (Department) в интерфейсе приложения.
...
- "Supervisor" - объединяет ui-minimal, "Edit employees" и "View departments"
